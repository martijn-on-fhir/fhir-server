...
describe('IpWhitelistGuard', () => {
    ...
    let logger: jest.Mocked<FsLoggerService>
    let mockRequest: any
    ...
    beforeEach(async () => {
        ...
        logger = {
            ...
            warn: jest.fn(),
            debug: jest.fn()
        } as unknown as jest.Mocked<FsLoggerService>
    ...
    describe('Disabled Configuration', () => {
        ...
        beforeEach(() => {
            ...
            guard = new IpWhitelistGuard(configService, logger)
        })
    ...
    describe('Enabled Configuration', () => {
        ...
        describe('Configuration Edge Cases', () => {
            it('should handle invalid IP configurations gracefully', () => {
                ...
                const testGuard = new IpWhitelistGuard(configService, logger)
                mockRequest.ip = '192.168.1.1'
    ...
    describe('Default Configuration', () => {
        it('should use default configuration when none provided', () => {
            ...
            const guard = new IpWhitelistGuard(configService, logger)
            mockRequest.ip = '192.168.1.1'
